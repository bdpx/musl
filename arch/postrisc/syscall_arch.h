...
static __inline void postrisc_dump_value(long line, char const *file, char const *func, long value)
{
    __syscall_postrisc(SYS_dump_value, line, (long)file, (long)func, value, 0, 0);
}

static __inline void postrisc_dump_memory(long line, char const *file, char const *func, void *memory, unsigned long size)
{
